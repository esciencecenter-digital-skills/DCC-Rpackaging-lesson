...
::: keypoints
- "It is important to think about **what** we want our package to do (_design_) and **how** will it do it (_implementation_). We also want to know **why** we need a new package (_avoid reinventing the wheel_)"
